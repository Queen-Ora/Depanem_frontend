        ...
        <div className="container mt-5">
            <Card className="text-center">
                <Card.Img 
                    ...
                    style={{ width: '150px', height: '150px', objectFit: 'cover', borderRadius: '50%', margin: '20px auto' }}
                />
                <Card.Body>
                    <Card.Title>{`${technician.lastname} ${technician.firstname}`}</Card.Title>
                    <Card.Text><strong>Profession:</strong> {technician.profession || "Non spécifiée"}</Card.Text>
                    <Card.Text><strong>Contact:</strong> {technician.phone || "Non spécifié"}</Card.Text>
                    <Card.Text><strong>Email:</strong> {technician.email || "Non spécifié"}</Card.Text>
